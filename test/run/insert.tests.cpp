...
namespace {
    ...
    auto const i8 = suite.test([](auto check) {
        ...
        felspar::parse::binary::unchecked_insert(ar1, std::uint8_t(123));
        check(ar1[0]) == 123;
        ...
        felspar::parse::binary::unchecked_insert(ab1, std::uint8_t(123));
        ...
        felspar::parse::binary::unchecked_insert(ac1, std::uint8_t(123));
        check(ac1[0]) == 123;
    ...
    auto const i16 = suite.test([](auto check) {
        ...
        felspar::parse::binary::unchecked_insert(ar1, std::uint16_t(0x1234));
        check(ar1[0]) == 0x12;
        check(ar1[1]) == 0x34;
