...
namespace {
    ...
    auto const i8 = suite.test([](auto check) {
        ...
        check(felspar::parse::binary::native::unchecked_extract<std::uint8_t>(ar))
                == 123;
        ...
        check(felspar::parse::binary::native::unchecked_extract<std::uint8_t>(ab))
                == 124;
        ...
        check(felspar::parse::binary::native::unchecked_extract<std::uint8_t>(ac))
                == 125;
    ...
    auto const i16 = suite.test([](auto check) {
        ...
        check(felspar::parse::binary::native::unchecked_extract<std::uint16_t>(ar))
                == 0x3412;
    ...
    auto const i32 = suite.test([](auto check) {
        ...
        check(felspar::parse::binary::native::unchecked_extract<std::uint32_t>(ar))
                == 0x7856'3412UL;
    ...
    auto const i64 = suite.test([](auto check) {
        std::array<std::uint8_t, 8> ar{0x12, 0x34, 0x56, 0x78,
                                       0x98, 0x76, 0x54, 0x32};
        check(felspar::parse::binary::native::unchecked_extract<std::uint64_t>(ar))
    ...
    auto const mi8 = suite.test([](auto check) {
        std::vector<std::byte> ar{std::byte{95}, std::byte{96}};
        {
            ...
            check(felspar::parse::binary::native::extract<std::uint8_t>(sp)) == 95;
            check(felspar::parse::binary::native::extract<std::uint8_t>(sp)) == 96;
            check(sp.empty()) == true;
        }
        {
            std::span<std::byte const> sp{ar.data(), ar.size()};
